...
import { FaSitemap, FaSun } from 'react-icons/fa'
  ...
  return (
    <>
        <Nav variant='pills' defaultActiveKey='/devices' className='flex-column'>
            ...
            <Nav.Link className='bg-secondary my-1 py-3 shadow' href='/ip'><span className='h5'><strong><FaSitemap className='me-3' />IP Address</strong></span></Nav.Link>
        </Nav>
    </>
  )
}
