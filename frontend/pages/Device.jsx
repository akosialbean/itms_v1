...
const Device = () => {
  ...
  return (
    <>
      <Container>
        <Card>
          <CardHeader key={device._id} className="bg-primary">
            <Card.Title className="text-light">{device.d_hostName}</Card.Title>
          </CardHeader>
          <Card.Body>
            <Container>
              <Row>
                <Col xs={12} s={12} md={3} lg={3} className="text-center">
                  {d_type === "Laptop" ? <FaLaptop size={100} /> : ""}
                  {d_type === "Desktop" ? <FaDesktop size={100} /> : ""}
                  {d_type === "Phone" ? <FaMobileAlt size={100} /> : ""}
                  {device.d_type == "Server" ? <FaServer size={60} /> : ""}
                  {device.d_type == "Mini PC" ? <FaRobot size={60} /> : ""}
                </Col>
                  ...
                  <Form onSubmit={handleSubmit}>
                    ...
                    <Row>
                      <Col lg={6}>
                        ...
                        >
                          ...
                          <Form.Select
                            onChange={(e) => setIpAddressUpdate(e.target.value)}
                            required
                          >
                    ...
                    <Row>
                      <Col lg={6}>
                        ...
                        >
                          <Form.Label>
                            Assigned to Department (Multiple Users)
                          </Form.Label>
                          <Form.Control
                            type="text"
                            ...
                            onChange={(e) =>
                              setAssignedToDepartment(e.target.value)
                            }
                          ></Form.Control>
                        </Form.Group>
                      </Col>
                      <Col lg={6}>
                        ...
                        >
                          <Form.Label>
                            Assigned to Employee (Dedicated User)
                          </Form.Label>
                          <Form.Control
                            type="text"
                            ...
                            onChange={(e) =>
                              setAssignedToEmployee(e.target.value)
                            }
                          ></Form.Control>
                        </Form.Group>
                      </Col>
                    ...
                    <Row className="justify-content-end" lg={3}>
                      <Button
                        type="submit"
                        variant="primary"
                        className="mt-3"
